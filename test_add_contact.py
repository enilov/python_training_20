...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        wd.find_element_by_name("middlename").send_keys("mid_name")
        wd.find_element_by_name("theform").click()
        ...
        wd.find_element_by_name("title").send_keys("totle")
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        ...
        wd.find_element_by_name("mobile").send_keys("321")
        wd.find_element_by_name("theform").click()
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("456")
        wd.find_element_by_name("theform").click()
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("654")
        wd.find_element_by_name("theform").click()
